...
const About = () => {
    ...
    <h1 className="text-center font-bold text-xl md:text-3xl">Meet With Our Team expert</h1>
		<div className="flex flex-row flex-wrap-reverse justify-center">
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/bNMRfFW/women.jpg" />
				<p className="text-xl font-semibold ">Aisha Rahman</p>
				<p className="dark:text-gray-400">Event Director</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/cQdXTTs/men1.jpg" />
				<p className="text-xl font-semibold ">Farid Ahmed</p>
				<p className="dark:text-gray-400">Creative Design Lead</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/RhT1VwS/ayo-ogunseinde-6-W4-F62s-N-y-I-unsplash.jpg" />
				<p className="text-xl font-semibold ">Nusrat Khan</p>
				<p className="dark:text-gray-400">Logistics Coordinator</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/KL306HY/men2.jpg" />
				<p className="text-xl font-semibold ">Shafiqul Islam</p>
				<p className="dark:text-gray-400">Marketing Manager</p>
			</div>
			<div className="flex flex-col justify-center m-8 text-center">
				<img alt="" className="self-center flex-shrink-0 w-24 h-24 mb-4 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://i.ibb.co/1nZ3D96/men3.jpg" />
				<p className="text-xl font-semibold ">Yasin Chowdhury</p>
